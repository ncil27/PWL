...
@section('page-title', 'Surat Keterangan Lulus')
@section('css')
...
<div class="page-heading">
    ...
    <p>Form untuk mengajukan Surat Keterangan Lulus</p>
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body">
                        <form action="{{ route('surat.skl.store') }}" method="POST">
                            @csrf
                            ...
                            <div class="row">    
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="tgl_lulus" id="tgl_lulus" class="form-control" placeholder="Tanggal Lulus" required>
                                    </div>
                                </div>                                
