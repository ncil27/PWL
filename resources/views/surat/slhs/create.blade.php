...
@section('page-title', 'Surat Laporan Hasil Studi')
@section('css')
<link rel="stylesheet" href="{{ asset('assets/extensions/toastify-js/src/toastify.css') }}"> 
@endsection
@section('content')
<div class="page-heading">
    <h3>Surat Laporan Hasil Studi</h3>
    <p>Form untuk mengajukan Surat Laporan Hasil Studi Sementara</p>
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body">
                        <form action="{{ route('surat.slhs.store') }}" method="POST">
                            @csrf
